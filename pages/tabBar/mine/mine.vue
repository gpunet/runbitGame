	...
	<view class="content">
		...
		<view>
			<uni-popup ref="inputDialog" type="dialog">
				...
				<uni-popup-dialog ref="inputClose" :mask-click="true" cancelText="取消" confirmText="合成" title="装备合成"
					...
					<view>
						...
						<uni-card title="" extra="" style="width: 90%; border:1px solid black; border-radius: 0.825rem; background-color:#F4F5F6 ; margin: 2rem auto;">
							...
							<view class="curId uni-flex uni-row">
								<view class="flex-item">旧装备等级</view>
								<view class="flex-item" style="margin-left: 2.5rem;">合成后等级</view>
							</view>
						...
						<view class="curId2 uni-flex uni-row">
							<view class="flex-item3">合成费用共计</view>
		...
		<view>
			<uni-popup ref="inputDialog4" type="dialog">
				...
				<uni-popup-dialog ref="inputClose" :mask-click="true" cancelText="取消" confirmText="添加" title="装备选择"
					value="对话框预置提示内容!" placeholder="请输入内容" @confirm="dialogInputConfirm">
					<view>
		...
		<view>
			<uni-popup ref="inputDialog2" type="dialog">
				...
				<uni-popup-dialog ref="inputClose" mode="base" :mask-click="true" cancelText="取消" confirmText="去背包"
					title="装备合成中" value="对话框预置提示内容!" placeholder="请输入内容" @confirm="dialogInputConfirm2">
					<view>


						<view class="uni-flex uni-row" style="width: 98%; margin: 10px auto;">
							<view class="id4">合成中...请稍后到背包查看</view>
		...
		<view>
			<uni-popup ref="inputDialog3" type="dialog">
				...
				<uni-popup-dialog ref="inputClose" :mask-click="true" cancelText="卸下" confirmText="转让" title="属性卡信息"
					value="对话框预置提示内容!" placeholder="请输入内容" @confirm="dialogInputConfirm4">
					<view>
						...
						<uni-card title="" extra="" style="width: 90%; border:1px solid black; border-radius: 0.825rem; background-color:#F4F5F6 ; margin: 1rem auto;">
									...
									<view class="curId uni-flex uni-row">
										...
										<view class="flex-item idvalue2">累计收益</view>
									</view>
						...
						<view class="uni-flex uni-row" style="width: 60%; text-align: center; margin: 10px auto;">
							<view class="id4">已安装于装备#001</view>
		...
		<view>
			<uni-popup ref="inputDialog5" type="dialog">
				<uni-popup-dialog ref="inputClose" :mask-click="true" cancelText="卸下" confirmText="确认" title="装备信息"
					value="对话框预置提示内容!" placeholder="请输入内容" @confirm="dialogInputConfirm">
					<view>
		...
		<view>
			<uni-popup ref="inputDialog6" type="dialog">
				...
				<uni-popup-dialog ref="inputClose" mode="input" :mask-click="true" cancelText="取消" confirmText="转让"
					title="转让" value="请校验正确的转让地址!" placeholder="请输入地址" @confirm="dialogInputConfirm2">
